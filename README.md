...
ocamlpolicy is a OCaml project for platform engineering. It focuses on this technical goal: Evaluate infrastructure policy rules against typed resource fixtures.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 183, risk penalty 4, latency penalty 2, and weight bonus 6. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
