"""Regression checks for the ocamlpolicy casebook."""
...
from casebook.harness import assert_expected, ocamlpolicy_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(ocamlpolicy_summary(), assert_expected())
